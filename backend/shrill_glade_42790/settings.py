"""
Django settings for shrill_glade_42790 project.
...
ROOT_URLCONF = 'shrill_glade_42790.urls'
...
WSGI_APPLICATION = 'shrill_glade_42790.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "shrill_glade_42790 API",
    "DESCRIPTION": "API documentation for shrill_glade_42790 App",
    "VERSION": "v1",
}
